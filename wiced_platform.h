...
typedef enum
{
    ...
    WICED_PLATFORM_GPIO_41,  //!< GPIO 41
    WICED_PLATFORM_GPIO_42,  //!< GPIO 42
    WICED_PLATFORM_GPIO_43,  //!< GPIO 43
    WICED_PLATFORM_GPIO_44,  //!< GPIO 44
    WICED_PLATFORM_GPIO_45,  //!< GPIO 45
